        ...
        <div className="mt-400 grid grid-cols-1 md:grid-cols-2 gap-400">
          ...
          <div>
            ...
            <ToggleGroup type="single" value={dateRange} onValueChange={value => value && onDateRangeChange(value as DateRangeType)} className="h-10 bg-background-level-2 border border-[rgba(255,255,255,0.08)] rounded-lg" disabled={isLoading}>
              ...
              <ToggleGroupItem value="weekly" className="h-10 data-[state=on]:bg-primary-200 data-[state=on]:text-text-icon-01 rounded-md font-normal">
                Weekly
              </ToggleGroupItem>
              <ToggleGroupItem value="monthly" className="h-10 data-[state=on]:bg-primary-200 data-[state=on]:text-text-icon-01 rounded-md font-normal">
                Monthly
              </ToggleGroupItem>
            </ToggleGroup>
          </div>
